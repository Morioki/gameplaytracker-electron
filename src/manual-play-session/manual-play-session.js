...
// TODO Build Date Time Picker object
const datePickerDiv = document.querySelector('#manual-datepicker-value')
...
recordSave.addEventListener('click', async () => {
	//console.log(datePickerDiv.value)
	//console.log(DateTime.fromFormat(datePickerDiv.value,'yyyy-LL-d HH:mm'))
	if (ps.sw.running) {
		return;
	}
	...
	// Set Manual Date
	ps.sw.startDate = DateTime.fromFormat(datePickerDiv.value,'yyyy-LL-d HH:mm')
